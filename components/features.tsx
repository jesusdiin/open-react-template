      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Educación + Tecnología = Futuro brillante.</h2>
            <p className="text-xl text-gray-400">En el Instituto Euro Americano Humanitas Juquila, estamos dedicados a cultivar el potencial de cada estudiante, preparándolos para liderar en un mundo impulsado por la tecnología y la creatividad.</p>
          </div>
